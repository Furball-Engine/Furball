...
namespace Furball.Game.Screens {
    public class LayoutingTest : TestScreen {
        ...
        public override void Initialize() {
            ...
            this.Manager.Add(this._topLeft     = new TexturedDrawable(FurballGame.WhitePixel, Vector2.Zero) {
                OriginType = OriginType.TopLeft,
                Scale      = new Vector2(25)
            });
            this.Manager.Add(this._topRight    = new TexturedDrawable(FurballGame.WhitePixel, Vector2.Zero) {
                OriginType = OriginType.TopRight,
                Scale = new Vector2(25)
            });
            this.Manager.Add(this._bottomLeft  = new TexturedDrawable(FurballGame.WhitePixel, Vector2.Zero) {
                OriginType = OriginType.BottomLeft,
                Scale = new Vector2(25)
            });
            this.Manager.Add(this._bottomRight = new TexturedDrawable(FurballGame.WhitePixel, Vector2.Zero) {
